...
class TransactionControllerIntegrationTest {
  ...
  private TransactionRequestDto createRequest(
      BigDecimal amount, String category, String senderBank) {
  ...
  void crudFlow() {
    ...
    // Get
    TransactionResponseDto fetched =
        webTestClient
            .get()
  ...
  void searchAndFilter() {
    ...
    webTestClient
        .get()
        .uri(
            uriBuilder -> uriBuilder.path("/api/transactions").queryParam("amountMin", 100).build())
        .exchange()
        .expectStatus()
        .isOk()
    ...
    webTestClient
        ...
        .uri(
            uriBuilder ->
                uriBuilder.path("/api/transactions").queryParam("category", "CAT1").build())
        .exchange()
        .expectStatus()
        .isOk()
        .expectBodyList(Object.class)
